...
const INTERFACES: &[(&str, &str, Option<&str>)] = &[
    ...
    ("hunk", "HunkIFace", None),
    ("i2c", "I2CIFace", None),
    ("i2c_resource", "I2CResourceIFace", Some("i2c")),
    ("icon", "IconIFace", None),
    ...
    ("mounter_private", "MounterPrivateIFace", Some("mounter")),
    ("nv", "NVIFace", Some("nonvolatile")),
    ("openfirmware", "OpenFirmwareIFace", None),
    ("p96", "P96IFace", Some("Picasso96API")),
    ("palette", "PaletteIFace", None),
    ("partition", "PartitionIFace", None),
    ("pasdma", "PASDMAIFace", Some("pasemi_dma")),
