...
const INTERFACES: &[&str] = &[
    "acpi", "amigaguide", "amigainput", "amisslmaster", "application",
    "arexx", "asl", "battclock", "battmem", "bevel",
    "bitmap_gc", "blankermodule", "bootsd", "btree", "bullet", "button",
    "bzip2", "card", "catweasel", "checkbox", "chooser", "cia", "clicktab",
    "colorwheel", "commodities",
    "console", "cyrus", "datatypes", "datebrowser", "debug", "diffview",
    "diskfont",
    "diskio", "docky", "dos", "drawlist", "elf", "exec", "expansion",
    "filler", "fsldma",
    "filesysbox", "fuelgauge", "gadtools",
    ...
    "pci", "penmap", "perfmon", "picture", "popupmenu", "potgo",
