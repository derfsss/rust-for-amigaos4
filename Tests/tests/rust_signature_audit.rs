...
const INTERFACES: &[&str] = &[
    ...
    "clicktab", "colorwheel", "commodities", "console", "cw3_floppy",
    "cw3_gameport", "cw3_keyboard", "cw3_sid", "cyrus", "datatypes",
    ...
    "nv", "palette", "partition", "pci", "penmap", "perfmon", "picture",
    "popupmenu", "potgo", "radiobutton", "ramdrive", "realtime", "requester",
